...
def save_high_score(ai_settings, stats):
	with open(ai_settings.score_file, "w") as f:
		f.write(str(stats.high_score))
		
	print("Saving High Score = %d" %stats.high_score)
		
def read_high_score(ai_settings, stats):
	with open(ai_settings.score_file, "r") as f:
		stats.high_score = int(f.read())
	
	print("Loading High Score = %d" %stats.high_score)
